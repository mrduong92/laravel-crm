...
Route::middleware([
    ...
    // Route::middleware('auth:owner')->group(function () {
        // Route::get('auth/password', [ChangePasswordController::class, 'displayChangePasswordForm'])->name('users.password');
        // Route::get('auth/profile', function () {
        //     return redirect()->route('users.edit', ['user' => Auth::id()]);
        // })->name('users.profile');
        // Route::put('auth/password', [ChangePasswordController::class, 'changePassword'])->name('users.change-password');
