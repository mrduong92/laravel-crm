<div id="info-modal" class="bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)]      min-h-screen">
    ...
    <section class="flex flex-col justify-start w-full">
        ...
        {{-- Only show if is not group --}}
            <button" wire:click="showViewSuggestionModal"
                class=" w-full cursor-pointer py-5 px-8 hover:bg-[var(--wc-light-secondary)] dark:hover:bg-[var(--wc-dark-secondary)] transition  flex gap-3 items-center">
                ...
                <span>{{ __('wirechat::chat.info.actions.view_suggestion.label') }}</span>
            </button>
